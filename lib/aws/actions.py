...
ACTIONS = {
    ...
    "ec2:AssociateEnclaveCertificateIamRole": {
        ...
        "Affects": {
            ...
            "AWS::Iam::Role": {"Condition Keys": [], "Dependant Actions": []},
        },
    ...
    "ec2:AssociateIamInstanceProfile": {
        ...
        "Affects": {
            "AWS::Ec2::Instance": {
                ...
                "Dependant Actions": ["iam:PassRole"],
            }
        },
    ...
    "ec2:CopyFpgaImage": {
        ...
        "Affects": {
            "AWS::Ec2::FpgaImage": {
                "Condition Keys": ["ec2:Owner", "ec2:Region"],
                "Dependant Actions": [],
            }
        },
    ...
    "ec2:CreateVpcEndpoint": {
        ...
        "Affects": {
            ...
            "AWS::Ec2::Vpc": {
                ...
                "Dependant Actions": ["route53:AssociateVPCWithHostedZone"],
            },
            "AWS::Ec2::VpcEndpoint": {
                "Condition Keys": [
                    "aws:ResourceTag/${TagKey}",
    ...
    "iam:AddUserToGroup": {
        "Access": "Write",
        "Affects": {
            "AWS::Iam::Group": {"Condition Keys": [], "Dependant Actions": []}
        },
    ...
    "iam:AttachUserPolicy": {
        "Access": "Permissions Management",
        "Affects": {
            "AWS::Iam::User": {"Condition Keys": [], "Dependant Actions": []}
        },
    ...
    "iam:CreatePolicy": {
        "Access": "Permissions Management",
        "Affects": {
            "AWS::Iam::Policy": {"Condition Keys": [], "Dependant Actions": []}
        },
    ...
    "s3:AbortMultipartUpload": {
        "Access": "Write",
        "Affects": {
            "AWS::S3::Object": {"Condition Keys": [], "Dependant Actions": []},
    ...
    "s3:CreateBucket": {
        "Access": "Write",
        "Affects": {
            "AWS::S3::Bucket": {"Condition Keys": [], "Dependant Actions": []}
        },
    ...
    "s3:DeleteJobTagging": {
        "Access": "Tagging",
        "Affects": {
            "AWS::S3::Job": {"Condition Keys": [], "Dependant Actions": []}
        },
